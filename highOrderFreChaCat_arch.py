...
class OminiInteraction(nn.Module):
    ...
    def forward(self, vis, inf, i, j):
        ...
        out1 = torch.matmul(attention1, fused_twoOrderSpa)
...
class highOrderFrequencyChannelCatFusion(nn.Module):
    def __init__(self, vis_channels=1, inf_channels=1,
                 n_feat=16):
        super(highOrderFrequencyChannelCatFusion,self).__init__()
